...
const SideBar = () => {
    ...
    return (
        <div className='p-5 shadow-lg w-56'>
            <ul>
                <li className='mb-1 -mt-4'>Home</li>
                <li className='my-1'>Shorts</li>
                <li className='my-1'>Subscriptions</li>
            </ul>
            <hr class="h-px my-2 -mx-4 bg-gray-200 border-0 dark:bg-gray-300"></hr>
            <ul className='my-2'>
            ...
            <div>
                ...
                <button className='rounded rounded-full border border-black m-1 py-1 px-5 bg-black text-white'>Sign in</button>
            </div>
            <hr class="h-px my-2 -mx-4 bg-gray-200 border-0 dark:bg-gray-300"></hr>
            <ul>
